...
namespace XmlCompare.Tests
{
    ...
    public class CompareTest
    {
        ...
        [InlineData(@"../../Tests/xml/twoelementsTextInside.xml", "../../Tests/xml/twoelementsTextInsideEq.xml", false, 1, 0, 0, 0, 0, 0, 0, 0, 0, 2, 1, 0)]
        [InlineData(@"../../Tests/xml/twoelementsTextInsideEq.xml", "../../Tests/xml/twoelementsTextInside.xml", false, 1, 0, 0, 0, 0, 0, 0, 0, 0, 2, 1, 0)]
        [InlineData(@"../../Tests/xml/twoelementsTextInside.xml", "../../Tests/xml/twoelementsTextInsideNEq.xml", false, 1, 0, 0, 0, 0, 0, 0, 0, 0, 2, 1, 0)]
        [InlineData(@"../../Tests/xml/twoelementsTextInsideNEq.xml", "../../Tests/xml/twoelementsTextInside.xml", false, 1, 0, 0, 0, 0, 0, 0, 0, 0, 2, 1, 0)]
